...
/** these methods are used for either
 * initializing/validating the structure/contents
 * of the database or for executing SQL statements
 * and are defined in database-core.cpp */
public:
    void initialize();
...
/** these methods make changes to the database
 * and are defined in database-update.cpp */
public:
...
/** these methods are used to query the database
 * and are defined in database-query.cpp */
public:
